...
| 2026-03-04 | #78 | Seed emotion, physical state, and activity labels: nested valence-based emotion labels (Pleasant/Neutral/Unpleasant → 18 child emotions), flat physical state labels including positive states, activity labels with categories; rename "Symptom" entry type to "Physical State"; bump seed VERSION to 3 |
